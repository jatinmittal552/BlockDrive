...
const Docs = () => {
  return (
 <div  className="bg-primary h-full px-6 md:px-[4rem] font-poppins overflow-x-hidden">
<Navbar />
<main className='flex ps-2 mt-4' >
<img src={friend} style={{width:"500px",height:"300px"}} data-aos="fade-right" />
...
<div classname="flex flex-col pl-10" style={{color:"rgba(255, 255, 255, 0.7)",marginLeft:"20px"}}>
  ...
  <p classname="text-dimWhite ">hwllo</p>
 <button  className='bg-secondary text-primary' style={{width:"300px",height:"40px",fontWeight:"500",borderRadius:"5px"}}>Share with friends</button>
</div>
<img src={upload} style={{marginLeft:"200px",width:"500px",height:"300px"}} />
    </main>
    <main className='flex ps-2 mt-4 '  data-aos="zoom-in">
    <img src={remove} style={{width:"500px",height:"300px"}} />
<div classname="flex flex-col pl-10" style={{color:"rgba(255, 255, 255, 0.7)",marginLeft:"40px"}}>
  ...
  <p classname="text-dimWhite ">hwllo</p>
  <button  className='bg-secondary text-primary' style={{width:"300px",height:"40px",fontWeight:"500",borderRadius:"5px"}}>Remove Access</button>
</div>
